...
#print(base64.b64encode(hashlib.sha1(("RH0W0AkAd7dA11352hU1Qg=="+"258EAFA5-E914-47DA-95CA-C5AB0DC85B11").encode()).digest()).decode())
##As this
#print(base64.b64encode(sha1("RH0W0AkAd7dA11352hU1Qg=="+"258EAFA5-E914-47DA-95CA-C5AB0DC85B11", False)).decode())